...
let var1 = /a/g;
console.log(challenge.match(var1).length);
...
2. Using console.log() print out the following quote by Mother Teresa:
    The quote "Love is not patronizing and charity isn't about pity, it is about love. Charity and love are the same -- with charity you give love, so don't just give money but reach out your hand instead."
...
console.log(typeof "10" == typeof 10 ? null : [+"10", String(10)]);

console.log(parseFloat("9.8") == 10 ? null : Math.ceil(parseFloat("9.8")));

console.log("python".includes("on") && "jargon".includes("on"));

console.log("I hope this course is not full of jargon.".includes("on"));

console.log((Math.random() * 101) % 100);

console.log((Math.random() * 51 + 50) % 101);

console.log((Math.random() * 256) % 255);
...
let wordsArray = sentence.replace(/[@#$%&;!]+/g, "");
...
let num_list = words.match(/[\d]+/g);

console.log(+num_list[0] + +num_list[1] + +num_list[2]);
